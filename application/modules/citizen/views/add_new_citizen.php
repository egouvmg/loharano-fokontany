...
<body class="loharano">
                    ...
                    <form id="localityHousehold">
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="locality" value="" name="locality" placeholder="...">
                            <span class="error_field error_locality"></span>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="household_size"><?=$this->lang->line('household_size');?> *</label>
                            <input type="text" class="form-control" id="household_size" readonly value="1" name="household_size" placeholder="...">
                            <span class="error_field error_household_size"></span>
                        </div>
                        <button type="submit" id="saveLocalityHousehold" class="btn btn-primary">Migrer</button>
  ...
  <script src="<?= plugin('bootstrap', 'js', 'bootstrap.bundle.min.js');?>"></script>
	...
	<script src="<?= plugin('modules', 'citizen', 'new_new_household.js');?>"></script>
