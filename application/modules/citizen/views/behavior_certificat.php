        ...
        <div >          
          ...
          <div class="row"><!-- https://codepen.io/pen/ style="background-color:lavender;"-->
            <div class="col-sm-8"  style="background-color:white;">
              ...
              <div class="form-group row" style="margin-bottom: 0px;">
               <div class="col-sm-12">
                  <span class="font-weight-bold" style="margin-bottom: 0px;">Lf :</span><?= " ".addslashes($citizen_data[0]->lf_behavior+1).' . '.date('y')."" ?>
                </div>
              </div>
            </div>
            <div class="col-sm-4 text-center" style="background-color:white;">
          ...
          <div class="row">
            ...
            <div class="row">
                <div class="col-sm-6">
                  <span style="padding-left:50px;" class="font-weight-bold">Natao teto :</span><?= " ".$citizen_data[0]->libelle_fokontany."" ?>
                  <p style="padding-left:75px;" class="font-italic">Fait à</p>
                </div>

                <div class="col-sm-6">
                  <span style="padding-left:50px;" class="font-weight-bold">androany faha </span><?= " ".date('d-m-Y')."" ?>
                  <p style="padding-left:75px;" class="font-italic">le</p>
                </div>
              </div>           
            </div>
          </div>
