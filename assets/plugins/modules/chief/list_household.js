$(function () {
	...
	var citizens = new Tabulator("#householdContent", {
        ...
        rowClick:function(e, row){
            histories.setData('historique_migration', {id_person:row.getData().person_id});
            histories_certificates.setData('historique_certificat', {id_person:row.getData().person_id});
    ...
    $('#fokontany').change(function(e){
        households.setData('chef_liste_menages', {fokontany_id:$(this).val()});
    });
